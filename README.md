...
2. PLS_gradients --> PLS with only one latent variable run on one gradient at a time. Two models: the first with diagnosis included as a behavioral variable and the second without including diagnosis.
